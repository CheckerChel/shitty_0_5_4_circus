...
token="8638079016:AAGVYew3z6IZJPMRYnarFN-ktQDoXLtRRjw"
...
def handle_callbacks(call):
    ...
    if call.data == "open_case":
        ...
        _, target_str, cases_str = call.data.split("_")
        target_real_id = int(target_str)
        cases_to_transfer = int(cases_str)
